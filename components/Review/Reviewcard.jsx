...
const recommendOptions = [
  {
    ...
    style:
      "hover:shadow hover:scale-105 bg-gray-100 hover:bg-green-300 hover:text-green-800",
    selectedStyle: " bg-green-200 text-green-600",
    val: "YES",
  },
  {
    ...
    style:
      "hover:shadow hover:scale-105 bg-gray-100 hover:bg-red-300 hover:text-red-800",
    selectedStyle: "bg-red-200 text-red-600",
    val: "NO",
  },
];
